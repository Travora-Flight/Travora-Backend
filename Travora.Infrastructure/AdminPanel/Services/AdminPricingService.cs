...
public class AdminPricingService : IAdminPricingService
{
    ...
    private Travora.Domain.Enums.ServiceType MapServiceType(string type) => type.ToLower() switch
    {
        ...
        "departure_baggage_handling" or "departurebaggagehandling" or "departure" => Travora.Domain.Enums.ServiceType.DepartureBaggageHandling,
        "arrival_baggage_handling" or "arrivalbaggagehandling" or "arrival" => Travora.Domain.Enums.ServiceType.ArrivalBaggageHandling,
    ...
    private Travora.Domain.Enums.ExecutionPhase MapExecutionPhase(string phase) => phase.ToLower() switch
    {
        ...
        "departure_checkin" or "departurecheckin" or "airport" => Travora.Domain.Enums.ExecutionPhase.DepartureCheckin,
        "arrival_checkin" or "arrivalcheckin" => Travora.Domain.Enums.ExecutionPhase.ArrivalCheckin,
